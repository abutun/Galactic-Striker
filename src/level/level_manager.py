...
class LevelManager:
    def __init__(self, start_level: int, enemy_group, sprite_group, bullet_group):
        ...
        # Preload initial levels
        self.resource_preloader.preload_initial_level()
        
        self.level_data = self._load_level_data(start_level)
        self.formation_index = 0
        self.level_complete = False
        self.level_transition_time = 2000
    ...
    def load_next_level(self):
        ...
        try:
            ...
            # Preload resources for the next level
            self.resource_preloader.preload_next_level(self.current_level)
