...
class Weapon4(PrimaryWeapon):
    def fire(self, player, bullet_group):
        ...
        b1 = Bullet(x - spacing, y, 0, -player.bullet_speed, damage)
        b2 = Bullet(x - spacing//2 + 2, y, 0, -player.bullet_speed, damage)
        b3 = Bullet(x + spacing//2 - 2, y, 0, -player.bullet_speed, damage)
        b4 = Bullet(x + spacing, y, 0, -player.bullet_speed, damage)
        bullet_group.add(b1)
        bullet_group.add(b2)
        bullet_group.add(b3)
        bullet_group.add(b4)
